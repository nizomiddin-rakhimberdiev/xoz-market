...
export default function AdminProducts() {
  ...
  const createMutation = useMutation({
    mutationFn: async ({ data, variants, images }: { data: typeof formData; variants: VariantFormItem[]; images: PendingImage[] }) => {
      const slug = data.slug || data.name.toLowerCase().replace(/[^a-z0-9\s-]/g, '').replace(/\s+/g, '-').replace(/-+/g, '-').trim() || `product-${Date.now()}`;
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="metr2">Metr² (kvadrat)</SelectItem>
                          <SelectItem value="metr3">Metr³ (kub)</SelectItem>
